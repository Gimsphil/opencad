...
Browse the example source: [Sweep path/profile example](https://github.com/Gimsphil/opencad/blob/main/main/opengeometry-three/examples-vite/operations/sweep-path-profile.html).
