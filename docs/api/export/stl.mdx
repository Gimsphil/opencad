...
Open CAD can export B-Reps to **binary STL**. You can export a single B-Rep payload or export a
...
an exporter limitation or confusing output, review the exporter examples and repository docs.
</Warning>
...
Browse the example source: [STL export example](https://github.com/Gimsphil/opencad/blob/main/main/opengeometry-three/examples-vite/operations/stl-export.html).
