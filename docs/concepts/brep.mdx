...
description: 'Understanding the BREP data structure in Open CAD'
---

Boundary Representation (BREP) is the core data structure used in Open CAD to represent geometric entities. It describes 3D objects by defining their boundaries through vertices, edges, and faces.
...
Open CAD can represent different types of geometric bodies:
