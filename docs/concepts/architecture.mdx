...
description: 'Understanding the layered architecture of Open CAD'
---

Open CAD is built with a layered architecture designed to bring high-performance CAD operations to the web. The system follows a clear separation between the computational core and the rendering layer.
